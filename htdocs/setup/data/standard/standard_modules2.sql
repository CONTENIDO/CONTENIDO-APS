...
-- form assistant
CREATE TABLE `!PREFIX!_pifa_contact_de` (`id` int(10) unsigned NOT NULL auto_increment COMMENT 'primary key',`salutation` varchar(255) default NULL,`first_name` varchar(255) default NULL,`last_name` varchar(255) default NULL,`company` varchar(255) default NULL,`street` varchar(255) default NULL,`street_number` varchar(255) default NULL,`plz` varchar(255) default NULL,`city` varchar(255) default NULL,`phone` varchar(255) default NULL,`email` varchar(255) default NULL,`message` text,`privacy` varchar(255) default NULL,PRIMARY KEY  (`id`)) ENGINE=MyISAM  AUTO_INCREMENT=11 ;
CREATE TABLE `!PREFIX!_pifa_contact_en` (`id` int(10) unsigned NOT NULL auto_increment COMMENT 'primary key',`salutation` varchar(255) default NULL,`first_name` varchar(255) default NULL,`last_name` varchar(255) default NULL,`company` varchar(255) default NULL,`street` varchar(255) default NULL,`street_number` varchar(255) default NULL,`plz` varchar(255) default NULL,`city` varchar(255) default NULL,`phone` varchar(255) default NULL,`email` varchar(255) default NULL,`message` text,`privacy` varchar(255) default NULL,PRIMARY KEY  (`id`)) ENGINE=MyISAM  AUTO_INCREMENT=11 ;
CREATE TABLE `!PREFIX!_pifa_field` (`idfield` int(10) unsigned NOT NULL auto_increment COMMENT 'unique identifier for a ConForm field',`idform` int(10) unsigned NOT NULL default '0' COMMENT 'foreign key for the ConForm form',`field_rank` int(10) unsigned NOT NULL default '0' COMMENT 'rank of a field in a form',`field_type` int(10) unsigned NOT NULL default '0' COMMENT 'id which defines type of form field',`column_name` varchar(64) NOT NULL COMMENT 'name of data table column to store values',`label` varchar(1023) default NULL COMMENT 'label to be shown in frontend',`display_label` int(1) NOT NULL default '0' COMMENT '1 means that the label will be displayed',`default_value` varchar(1023) default NULL COMMENT 'default value to be shown for form field',`option_labels` varchar(1023) default NULL COMMENT 'CSV of option labels',`option_values` varchar(1023) default NULL COMMENT 'CSV of option values',`option_class` varchar(1023) default NULL COMMENT 'class implementing external datasource',`help_text` text COMMENT 'help text to be shown for form field',`obligatory` int(1) NOT NULL default '0' COMMENT '1 means that a value is obligatory',`rule` varchar(1023) default NULL COMMENT 'regular expression to validate value',`error_message` varchar(1023) default NULL COMMENT 'error message to be shown for an invalid value',`css_class` varchar(1023) default NULL COMMENT 'CSS classes to be used for field wrapper',PRIMARY KEY  (`idfield`)) ENGINE=MyISAM COMMENT='contains meta data of PIFA fields' AUTO_INCREMENT=1 ;
...
INSERT INTO `!PREFIX!_pifa_field` VALUES (19, 2, 1, 6, 'salutation', 'Salutiation', 1, NULL, 'Please select,Mrs,Mr', ',Mrs,Mr', NULL, NULL, 1, NULL, 'Please select the salutation', NULL);
INSERT INTO `!PREFIX!_pifa_field` VALUES (20, 2, 2, 1, 'first_name', 'First name', 1, NULL, NULL, NULL, NULL, NULL, 1, NULL, 'Please insert your first name', NULL);
INSERT INTO `!PREFIX!_pifa_field` VALUES (21, 2, 3, 1, 'last_name', 'Last name', 1, NULL, NULL, NULL, NULL, NULL, 1, NULL, 'Please insert your last name', NULL);
INSERT INTO `!PREFIX!_pifa_field` VALUES (22, 2, 4, 1, 'company', 'Company', 1, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL);
INSERT INTO `!PREFIX!_pifa_field` VALUES (23, 2, 5, 1, 'street', 'Street', 1, NULL, NULL, NULL, NULL, NULL, 1, NULL, 'Please insert your street name', NULL);
INSERT INTO `!PREFIX!_pifa_field` VALUES (24, 2, 6, 1, 'street_number', 'Street number', 1, NULL, NULL, NULL, NULL, NULL, 1, NULL, 'Please insert your street number', NULL);
INSERT INTO `!PREFIX!_pifa_field` VALUES (25, 2, 7, 1, 'plz', 'Zip', 1, NULL, NULL, NULL, NULL, NULL, 1, NULL, 'Please insert your zip code', NULL);
INSERT INTO `!PREFIX!_pifa_field` VALUES (26, 2, 8, 1, 'city', 'City', 1, NULL, NULL, NULL, NULL, NULL, 1, NULL, 'Please insert your City', NULL);
INSERT INTO `!PREFIX!_pifa_field` VALUES (27, 2, 10, 1, 'phone', 'Phone', 1, NULL, NULL, NULL, NULL, NULL, 1, NULL, 'Please insert your phone number', NULL);
INSERT INTO `!PREFIX!_pifa_field` VALUES (28, 2, 11, 1, 'email', 'E-Mail', 1, NULL, NULL, NULL, NULL, NULL, 1, NULL, 'Please insert your e-mail address', NULL);
INSERT INTO `!PREFIX!_pifa_field` VALUES (29, 2, 9, 2, 'message', 'Your message', 1, NULL, NULL, NULL, NULL, NULL, 1, NULL, 'Please insert your message', NULL);
INSERT INTO `!PREFIX!_pifa_field` VALUES (30, 2, 13, 13, '', 'Send', 1, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, 'button_red');
INSERT INTO `!PREFIX!_pifa_field` VALUES (31, 2, 14, 14, '', 'Cancel', 0, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, 'button_grey');
INSERT INTO `!PREFIX!_pifa_field` VALUES (32, 2, 12, 5, 'privacy', 'Privacy', 1, NULL, 'I accept the privacy policy', '1', NULL, NULL, 1, NULL, 'Please accept the privacy policy', 'privacy');
...
INSERT INTO `!PREFIX!_pifa_form` VALUES (1, 1, 1, 'contact', '!PREFIX!_pifa_contact_de', 'post', 1);
INSERT INTO `!PREFIX!_pifa_form` VALUES (2, 1, 2, 'contact', '!PREFIX!_pifa_contact_en', 'post', 1);
