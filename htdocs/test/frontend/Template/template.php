...
class TemplateUnitTest extends PHPUnit_Framework_TestCase {
    ...
    /**
     * functions with the @test annotation will be executed while the test
     * process.
     * The function name should be the name of the function you want to test
     * with additional suffix 'Test'
     * @test
     */
