...
<meta name="description" content="Die Philosophie von CONTENIDO" />
...
<p>Unsere Prinzipien: <a href=\"front_content.php?idart=66\">Einfach benutzen</a>, <a href=\"front_content.php?idart=67\">einfach grenzenlos</a>, <a href=\"front_content.php?idart=68\">einfach einfach</a>.</p>"; if (cRegistry::isBackendEditMode()) { $label = mi18n("LABEL_TEXT"); } else { $label = NULL; } $tpl = cSmartyFrontend::getInstance(); $tpl->assign('label', $label); $tpl->assign('text', $text); $tpl->display('get.tpl'); ?>
                </div>
                <?php
$cCurrentModule = 6;
