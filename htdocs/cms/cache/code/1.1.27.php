...
<meta name="keywords" content="contenido, cms, beispielwebsite, installieren, installation, management, einfache, einstieg, gezeigte, plugins, modulen, gelingt, systems, content" />
</head>
...
?><?php
 defined('CON_FRAMEWORK') || die('Illegal call: Missing framework initialization - request aborted.'); $text = "<p>Bei der Installation des Content Management Systems CONTENIDO k&ouml;nnen Sie die hier gezeigte Beispielwebsite installieren. Damit gelingt Ihnen der einfache Einstieg in das CMS. Die Beispielwebsite bringt bereits \"ab Werk\" eine F&uuml;lle von Modulen und Plugins mit.</p>"; if (cRegistry::isBackendEditMode()) { $label = mi18n("LABEL_TEXT"); } else { $label = NULL; } $tpl = cSmartyFrontend::getInstance(); $tpl->assign('label', $label); $tpl->assign('text', $text); $tpl->display('get.tpl'); ?>
                </div>
                <?php
$cCurrentModule = 6;
