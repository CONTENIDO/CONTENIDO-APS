...
<meta name="description" content="Features of this website" />
<meta name="keywords" content="contenido, automatically, sample, management, installing, understand, installed, contains, features, already, variety, content, plugins, system, easily" />
</head>
...
?><?php
 defined('CON_FRAMEWORK') || die('Illegal call: Missing framework initialization - request aborted.'); $text = "<p>When installing CONTENIDO this sample site can be automatically installed as well.&nbsp; This will help you to easily learn and understand the content management system. The sample site already contains a variety of features and plugins.</p>"; if (cRegistry::isBackendEditMode()) { $label = mi18n("LABEL_TEXT"); } else { $label = NULL; } $tpl = cSmartyFrontend::getInstance(); $tpl->assign('label', $label); $tpl->assign('text', $text); $tpl->display('get.tpl'); ?>
                </div>
                <?php
$cCurrentModule = 6;
