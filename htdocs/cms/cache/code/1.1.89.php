...
<meta name="keywords" content="contenido, xing, konfigurierbare, untersützung, button, verschiedene, eingebunden, plattformen, eingebaute, genannten, kategorie, timelines, facebook, beispiel, \"like\"" />
</head>
...
?><?php
 defined('CON_FRAMEWORK') || die('Illegal call: Missing framework initialization - request aborted.'); $text = "<p>CONTENIDO bietet eine eingebaute Unters&uuml;tzung f&uuml;r verschiedene Social Media Plattformen.</p>
<p>Es gibt vier einfach konfigurierbare Module f&uuml;r einen XING Link, den Google \"+1\" Button, den Facebook \"Like\" Button und die eingebunden Timelines von Twitter.</p>
<p>Sie finden zu jedem genannten ein Beispiel in dieser Kategorie.</p>"; if (cRegistry::isBackendEditMode()) { $label = mi18n("LABEL_TEXT"); } else { $label = NULL; } $tpl = cSmartyFrontend::getInstance(); $tpl->assign('label', $label); $tpl->assign('text', $text); $tpl->display('get.tpl'); ?>
                </div>
                <?php
$cCurrentModule = 6;
...
?><?php
 defined('CON_FRAMEWORK') || die('Illegal call: Missing framework initialization - request aborted.'); $tpl = cSmartyFrontend::getInstance(); $tpl->assign('isBackendEditMode', cRegistry::isBackendEditMode()); $tpl->assign('label', mi18n("LABEL_TEASERIMAGE")); $tpl->assign('image', ""); $tpl->assign('editor', "<img id=\"m2\" src=\"\" alt=\"\" title=\"\" />"); $tpl->display('get.tpl'); ?>
                <?php
$cCurrentModule = 0;
